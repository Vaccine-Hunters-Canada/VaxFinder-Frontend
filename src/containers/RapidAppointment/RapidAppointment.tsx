...
export function RapidAppointment() {
  ...
  const discordWebhook = () => {
    ...
    let doseString = "";
    if (isFirstDose && isSecondDose && isThirdDose) {
      doseString = "First, Second, Third Doses";
    } else if (isFirstDose && isSecondDose) {
      doseString = "First and Second";
    } else if (isFirstDose && isThirdDose) {
      doseString = "First and Third";
    } else if (isSecondDose && isThirdDose) {
      doseString = "Second and Third";
    } else if (isFirstDose) {
      doseString = "First Dose Only";
    } else if (isSecondDose) {
      doseString = "Second Dose Only";
    } else if (isThirdDose) {
      doseString = "Third Dose Only";
    }

    const autoGeneratedTweet = `${city}\n${
      vaccineId === 1 ? "Vaccine Type Not Reported" : vaccineTypeString
    }\nDose 1: ${
      vaccineId === 3 ? "Anyone 12+" : "Anyone 18+"
